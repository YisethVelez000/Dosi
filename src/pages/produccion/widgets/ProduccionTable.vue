...
const columns = defineVaDataTableColumns([
  { label: 'Nº Produccion', key: 'NumeroOrdenProduccion', sortable: true },
  { label: 'Fecha Estimada Entrega', key: 'FechaEstimada', sortable: true },
  { label: 'Es Produccion Interna', key: 'EsProduccionInterna', sortable: true },
  { label: 'Valor a Pagar', key: 'Terciarias.ValorAPagar', sortable: true },
...
<template>
  ...
  >
    ...
    <template #cell(ValorAPagar)="row">
      <!-- Verifica si hay alguna 'Terciaria' y muestra su 'ValorAPagar', de lo contrario muestra 'N/A' -->
      {{ row.rowData.Terciarias.length > 0 ? row.rowData.Terciarias[0].ValorAPagar || 'N/A' : 'N/A' }}
    </template>
