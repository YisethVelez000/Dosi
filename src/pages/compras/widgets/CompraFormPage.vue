        ...
        <VaForm v-slot="{ isValid }" ref="form">
          ...
          <div class="flex gap-4 flex-col sm:flex-row w-full">
            ...
            <VaInput
              ...
              label="Recibo"
              class="w-full sm:w-1/2"
              :rules="[validators.required, validators.noSpaces, validators.maxLength]"
              name="Recibo"
            />
          </div>
          ...
          <div class="flex items-center gap-4">
            ...
            <div v-if="proveedorSeleccionado" class="selected-proveedor">
              <span><strong>Proveedor Seleccionado: </strong>{{ proveedorSeleccionado.NombreProveedor }}</span>
            </div>
          </div>
...
validators.required = (value: string) => !!value || 'El campo es obligatorio'
validators.maxLength = (value: string) => value.length <= 100 || 'No puede exceder 100 caracteres'
validators.noSpaces = (value: string) => value.trim().length > 0 || 'No puede contener solo espacios'
