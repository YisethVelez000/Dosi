    ...
    <div class="flex gap-4 flex-col sm:flex-row w-full">
      <VaInput
        ...
        :rules="[
          ...
          (v: string) => /^[a-zA-Z\s]*$/.test(v) || 'El nombre solo puede contener letras',
          //Validar esapcios en blanco
          (v: string) => !/^\s/.test(v) || 'El nombre no puede empezar con un espacio en blanco',
          //Validar que no tenga mas de un espacio en blanco
          (v: string) => !/\s{2,}/.test(v) || 'El nombre no puede tener más de un espacio en blanco',
        ]"
        class="w-full sm:w-1/2"
      ...
      <VaInput
        ...
        :rules="[
          (v: any) => !!v || 'El apellido es requerido',
          (v: string) => /^[a-zA-Z\s]*$/.test(v) || 'El apellido solo puede contener letras',
          //Validar esapcios en blanco
          (v: string) => !/^\s/.test(v) || 'El apellido no puede empezar con un espacio en blanco',
          //Validar que no tenga mas de un espacio en blanco
          (v: string) => !/\s{2,}/.test(v) || 'El apellido no puede tener más de un espacio en blanco',
        ]"
        class="w-full sm:w-1/2"
    ...
    <div class="flex gap-4 flex-col sm:flex-row w-full">
      <VaInput
        ...
        :rules="[
          ...
          (v: string) => /^[a-zA-Z0-9\s]*$/.test(v) || 'La dirección solo puede contener letras y números',
          //Validar esapcios en blanco
          (v: string) => !/^\s/.test(v) || 'La dirección no puede empezar con un espacio en blanco',
          //Validar que no sean solo espacios en blanco
          (v: string) => !/^\s+$/.test(v) || 'La dirección no puede ser solo espacios en blanco',
        ]"
      />
